# Jupyter Apache Spark Standalone Cluster avec Docker
 L'objectif de ce projet est de mettre en place un Cluster Spark avec une instance Jupyter sur Docker
